...
>
  <head>
    ...
    <title>Login | Rivers Accord Situation Room</title>
              ...
              <div class="app-brand justify-content-center mb-4 mt-2">
                <a href="index.html" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="/logo.jpeg" height="30" width="30" alt="logo"/>
                  </span>
                  <span class="app-brand-text demo text-body fw-bold ms-1">Accord Party</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-1 pt-2">Welcome to Rivers Accord Situation Room! 👋</h4>
              {{-- <p class="mb-4">Please sign-in to your account and start the adventure</p> --}}
              <ul id="error_list"></ul>
              <form id="login_form" class="mb-3">
                <div class="mb-3">
                  <label for="email" class="form-label">Phone Number/Email</label>
                  <input
                    type="text"
                    class="form-control"
                    id="login"
